...
void Plane::calc_airspeed_errors()
{
    ...
    // modified by Xinglong Ju 20210519
...
void Plane::update_loiter(uint16_t radius)
{
    ...
    // 0: waypoint guide 1: direct lateral control 2: direct lateral control + direct pitch control
    if(next_WP_loc.control_mode == 0){
        if (radius <= 1) {
